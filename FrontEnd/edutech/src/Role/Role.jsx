...
//   const postApi = async () => {
//     try {
//       await axios.post('http://localhost:5050/addrole', formData);
//       fetchData();
//       setFormData({
//         role_id: '',
//         role_name: ''
...
//     try {
//       await axios.patch(`http://localhost:5050/updaterole/${formData.role_id}`, formData);
//       fetchData();
//       setFormData({
//         role_id: '',   
//         role_name: ''
...
//                   <tr key={index}>
//                     <td className="px-5 py-5 border-b border-blue-400 text-lg">
//                       <p className="text-black whitespace-no-wrap">{index + 1}</p>
//                     </td>
//                     <td className="px-5 py-5 border-b border-blue-400 text-lg">
//                       <p className="text-black  whitespace-no-wrap">{item.role_id}</p>
//                     </td>
//                     <td className="px-5 py-5 border-b border-blue-400 text-lg">
//                       <p className="text-black whitespace-no-wrap">{item.role_name}</p>
//                     </td>
//                     <td className="px-5 py-5 border-b border-blue-400 text-lg">
//                       <button
...
//             </button>
//             <h2 className="text-lg font-semibold mb-4">{isUpdating ? 'Update Role' : 'Add New Role'}</h2>
//             <form onSubmit={(e) => { e.preventDefault(); isUpdating ? updateApi() : postApi(); }}>
//               <div className="mb-4">
//                 <label htmlFor="role_id" className="block text-gray-700 text-sm font-bold mb-2">Role ID:</label>
//                 <input
//                   type="text"
//                   name="role_id"
//                   id="role_id"
...
//                   required
//                   readOnly={isUpdating} // Make the role ID read-only when updating
//                 />
//               </div>
//               <div className="mb-6">
//                 <label htmlFor="role_name" className="block text-gray-700 text-sm font-bold mb-2">Role Name:</label>
//                 <input
//                   type="text"
//                   name="role_name"
//                   id="role_name"
...
//                 >
//                   {isUpdating ? 'Update Role' : 'Add Role'}
//                 </button>
//               </div>
//             </form>
//           </div>
...
// <form class="max-w-md mx-auto mr-4 py-2">   
...
//             </svg>
//         </div>
//         <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search feilds ..." required />
...
//             className={`px-3 py-1 mx-1 border-2 rounded-lg ${currentPage === index + 1 ? 'bg-blue-600 text-white' : 'bg-white text-blue-600'}`}
//           >
//             {index + 1}
//           </button>
//         ))}
...
const Role = () => {
  ...
  const filteredData = data.filter(item =>
    item.role_id.toLowerCase().includes(searchQuery.toLowerCase()) ||
      ...
      <div className="flex justify-center mt-4">
        {Array.from({ length: totalPages }, (_, index) => (
          <button
            key={index + 1}
            onClick={() => paginate(index + 1)}
            className={`px-3 py-1 mx-1 border-2 border-blue-500 rounded-lg ${currentPage === index + 1 ? 'bg-blue-600 text-white' : 'bg-white text-blue-900'}`}
          >
            {index + 1}
          </button>
        ))}
